...
- [anti-debugging-techniques](related-skill: anti-debugging-techniques) when the obfuscated binary also has anti-debug layers
- [symbolic-execution-tools](related-skill: symbolic-execution-tools) when using angr/Z3 for automated deobfuscation
- [vm-and-bytecode-reverse](related-skill: vm-and-bytecode-reverse) for deep VM protector bytecode analysis
