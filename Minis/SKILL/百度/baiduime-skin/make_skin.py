...
PNG = bytes.fromhex('89504e470d0a1a0a0000000d4948445200000010000000100802000000909168360000000c49444154789c6360f8cf00000002000168651a1a0000000049454e44ae426082')

def mkpng(w=16,h=16,r=200,g=200,b=200):
    sig=b'\x89PNG\r\n\x1a\n'
...
def create(name,auth,out):
    p = {"name":name,"auth":auth,"out":out}
...
""")
        ...
        # STYLE161-183: graph icons (24 icons)
