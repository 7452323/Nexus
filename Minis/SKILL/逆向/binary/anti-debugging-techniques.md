...
- [code-obfuscation-deobfuscation](related-skill: code-obfuscation-deobfuscation) when the binary also uses control flow flattening, VM protection, or string encryption
- [vm-and-bytecode-reverse](related-skill: vm-and-bytecode-reverse) when the anti-debug sits inside a custom VM dispatcher
- [symbolic-execution-tools](related-skill: symbolic-execution-tools) when you want to symbolically skip anti-debug checks entirely
